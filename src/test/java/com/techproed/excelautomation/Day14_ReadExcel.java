...
//        Store the path of the  file in a string
        String path = ".\\src\\test\\java\\resourses\\Capitals.xlsx";
//        Open the file
...
//        Print country, capitol key value pairs as map object
        ...
        int capitalColumn = 1;
        /*
         * Starting row number : 1 =>cause row 0 is Header
...
//            }
    ...
    public void excelUtilDemo(){
        ...
        //Find the number of column in Capitals sheet
